...
gweather_info_get_temp (GWeatherInfo *info)
{
    ...
    return temperature_string (priv->temp, GWEATHER_TEMP_UNIT_FAHRENHEIT, FALSE); // TODO celcius etc
}
...
gweather_info_get_temp_min (GWeatherInfo *info)
{
    ...
    return temperature_string (priv->temp_min, GWEATHER_TEMP_UNIT_FAHRENHEIT, FALSE);
}
...
gweather_info_get_temp_max (GWeatherInfo *info)
{
    ...
    return temperature_string (priv->temp_max, GWEATHER_TEMP_UNIT_FAHRENHEIT, FALSE);
}
...
gweather_info_get_dew (GWeatherInfo *info)
{
    ...
    return temperature_string (priv->dew, GWEATHER_TEMP_UNIT_FAHRENHEIT, FALSE);
}
...
gweather_info_get_apparent (GWeatherInfo *info)
{
    ...
    return temperature_string (apparent, GWEATHER_TEMP_UNIT_FAHRENHEIT, FALSE);
}
...
gweather_info_get_wind (GWeatherInfo *info)
{
	...
	speed_string = windspeed_string (priv->windspeed, GWEATHER_SPEED_UNIT_MPH); //XXX
...
gweather_info_get_pressure (GWeatherInfo *info)
{
    ...
    switch (GWEATHER_PRESSURE_UNIT_INCH_HG) {
...
gweather_info_get_visibility (GWeatherInfo *info)
{
    ...
    switch (GWEATHER_DISTANCE_UNIT_MILES) {
...
gweather_info_get_temp_summary (GWeatherInfo *info)
{
    ...
    return temperature_string (priv->temp, GWEATHER_TEMP_UNIT_FAHRENHEIT, TRUE);
}
...
gweather_info_get_weather_summary (GWeatherInfo *info)
{
    ...
    out = g_strdup (buf); //g_strdup_printf ("%s: %s", gweather_info_get_location_name (info), buf);
		   ...
		   GSettings *settings)
{
    ...
    *value = 0.0;
    ...
    if (to_unit == GWEATHER_TEMP_UNIT_DEFAULT)
	    to_unit = GWEATHER_TEMP_UNIT_FAHRENHEIT;
	     ...
	     GSettings         *settings)
{
    ...
    *value = -1.0;
    ...
    if (to_unit == GWEATHER_SPEED_UNIT_DEFAULT)
	    to_unit = GWEATHER_SPEED_UNIT_MPH;
		...
		GSettings            *settings)
{
    ...
    *value = -1.0;
    ...
    if (to_unit == GWEATHER_PRESSURE_UNIT_DEFAULT)
	    to_unit = GWEATHER_PRESSURE_UNIT_INCH_HG;
		...
		GSettings            *settings)
{
    ...
    *value = -1.0;
    ...
    if (to_unit == GWEATHER_DISTANCE_UNIT_DEFAULT)
	    to_unit = GWEATHER_DISTANCE_UNIT_MILES;
